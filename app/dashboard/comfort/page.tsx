  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <motion.div 
        ...
        className="relative border-b border-amber-900/10 bg-[#0d0f12] py-8 overflow-hidden group"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/5 to-amber-500/0 opacity-50"></div>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
            <div className="flex items-center gap-3">
              <motion.div 
                ...
                className="w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_10px_rgba(251,191,36,0.6)]"
              ></motion.div>
              <h1 className="text-2xl md:text-3xl font-sans font-medium tracking-tight text-[#FFD700]">
                Comfort
              </h1>
            </div>
            <div className="hidden md:block h-6 w-[1px] bg-amber-900/40"></div>
            <p className="text-slate-500 text-sm md:text-base font-light italic tracking-wide">
              Qulay va oilaviy <span className="text-amber-200/60 uppercase text-[10px] tracking-[0.2em] ml-2 font-bold">Safe & Easy</span>
            </p>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div 
        ...
        className="py-12 bg-gradient-to-br from-[#16181d] to-[#0a0b0d]"
      >
        <CarGrid category="comfort" />
      </motion.div>
