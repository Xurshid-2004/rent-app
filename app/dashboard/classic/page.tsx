  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        variants={fadeInUp}
        className="relative border-b border-amber-900/10 bg-[#0d0f12] py-5 overflow-hidden group"
      >
        <div className="absolute top-0 right-0 w-64 h-full bg-amber-500/5 blur-[80px] rounded-full pointer-events-none"></div>
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl md:text-3xl font-serif italic tracking-widest text-[#FFD700] uppercase -skew-x-6">
              Classic
            </h1>
            <div className="h-[2px] w-10 bg-amber-500 rounded-full"></div>
            <p className="hidden md:block text-slate-500 text-[10px] md:text-xs uppercase tracking-[0.2em] font-medium">
              Retromobile <span className="text-amber-600/60 font-bold">Collection</span>
            </p>
          </div>
          <span className="text-[10px] text-amber-500/50 uppercase font-bold tracking-widest border-l border-amber-900/30 pl-3">
            Klassik avtomobillar
          </span>
        </div>
      </motion.div>
      ...
      <motion.div 
        ...
        className="py-1 bg-[#0d0f12]"
      >
        <CarGrid category="classic" />
      </motion.div>
